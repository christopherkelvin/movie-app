    ...
    <div className="w-full relative overflow-hidden">
      <div className="relative h-[400px] w-full max-sm:h-auto">
        <img
          ...
          className="h-full w-full object-cover transition-opacity duration-700 ease-in-out opacity-100"
        />
      ...
      <div
        key={currentMovie.id}
        className="absolute top-1/4 left-10 text-white flex flex-col gap-2 transition-all duration-700 ease-in-out"
      >
        ...
        <div className="mt-10 p-4 bg-[var(--highlight)] rounded-2xl w-28 text-center cursor-pointer hover:opacity-80 transition">
          Watch
        </div>
      </div>
